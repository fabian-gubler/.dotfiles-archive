...
static const unsigned int systraypinning = 0;  /* follow selected monitor */
static const unsigned int systrayonleft = 0;   /* 0: right corner */
static const unsigned int systrayspacing = 10; /* systray spacing */
static const int systraypinningfailfirst = 1;  /* 1: pin on first monitor */
...
static char *colors[][3] = {
    ...
    [SchemeInfoSel] = {selfgcolor, normbgcolor, "#000000"},
...
static const Rule rules[] = {
    ...
    {"pavucontrol", NULL, NULL, 0, 1, -1, 50, 50, 1000, 1000, 0},
};
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_k, spawn,
     SHCMD("$HOME/.dotfiles/scripts/dmenu/layout")},
